    ...
    <div className="min-h-screen bg-[#0a0b0f] flex items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-lg space-y-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-4 rounded-xl bg-violet-600 hover:bg-violet-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-semibold text-white"
        >
          {step === 'confirming' && (
