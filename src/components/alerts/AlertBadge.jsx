...
import {
  ...
  FileCode, X, ArrowRight, Fish, Activity, UserCheck, Repeat2, TrendingUp,
} from 'lucide-react'
...
const TYPE_META = {
  ...
  wallet_entry:         { icon: UserCheck,     label: 'Whale Entry',   color: 'text-green',     bg: 'bg-green/10 border-green/25' },
  wallet_repeat_mint:   { icon: Repeat2,       label: 'Repeat Mint',   color: 'text-amber-400', bg: 'bg-amber-500/10 border-amber-500/25' },
  wallet_large_mint:    { icon: TrendingUp,    label: 'Large Mint',    color: 'text-accent3',   bg: 'bg-accent3/10 border-accent3/25' },
